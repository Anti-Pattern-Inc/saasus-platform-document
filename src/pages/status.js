...
function StatusContent() {
    ...
    const incident = !isReady ? undefined : saasusPlatformMaintenancemode?.enabled ? saasusPlatformMaintenancemode : null;
    ...
    return (<main className={styles.main}>
      ...
      {incident === undefined ? (<div className={styles.loading}>Loading...</div>) : incident === null ? (<div className={styles.operationalCard}>
...
export default function StatusPage() {
    ...
    const ldClientId = siteConfig.customFields?.ldClientId;
    return (<Layout title={translate({ id: 'status.title', message: 'Status' })} description={translate({ id: 'status.description', message: 'SaaSus Platform Service Status' })}>
