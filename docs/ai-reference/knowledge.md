...
- Version: `current`
- Locale: `ja`
- Docs source: `i18n/ja/docusaurus-plugin-content-docs/current`
- API source: `api`
- Generated: `2026-05-12 11:54:57 +0900`



---

## changelog/20221224.md
...
## changelog/welcome-to-saasus-platform.md
...
## part-1/purpose-and-overview.md
...
## part-2/cloud-computing-basics.md
...
## part-2/saas-advantages-and-disadvantages.md
...
## part-2/saas-security-and-compliance.md
...
## part-2/saas-technical-architecture.md
...
## part-3/login-and-main-screen-overview.md
...
## part-3/saasus-platform-architecture.md
...
## part-4/account-settings/aws-marketplace-subscription-procedure.md
...
AWS Marketplace - SaaSus Platform
...
## part-4/account-settings/billing-information.md
...
## part-4/account-settings/procedure-for-applying-for-a-paid-plan.md
...
詳細な手順についてはこちらをご参照ください。
````


---

## part-4/account-settings/saasususerinvitation.md
...
1. SaaS開発コンソールのメニューから「アカウント設定」をクリックします
   ...
   saasususerinvitation-1
2. 「ユーザー管理」タブをクリックします
3. 「招待」ボタンをクリックします

   saasususerinvitation-2
4. 招待するユーザーのメールアドレスの入力と権限の選択をし、「招待」ボタンのクリックします

   saasususerinvitation-3
...
4. ユーザーの招待状況が表示されるので、キャンセルを行う場合は対象ユーザーの右端にあるゴミ箱のマークをクリックしてください
   ...
   saasususerinvitation-4
````


---

## part-4/application-settings/api-key-settings.md
...
## part-4/application-settings/basic-app-settings.md
...
## part-4/application-settings/declare-additional-attribute-to-tenant.md
...
## part-4/application-settings/domain-and-redirect-settings.md
...
## part-4/application-settings/googletagmanagersetting.md
...
## part-4/application-settings/googletagmanagersetting/creategoogleanalyticsaccount.md

````markdown
Google Tag Managerに設定するためにGoogle Analyticsアカウントを作成していきます。

1. Google Analyticsにアクセスし、「測定を開始」を押す
2. アカウント名の入力とアカウントのデータ共有設定し、次へを押す

   creategoogleanalyticsaccount-1

   - アカウント名：任意
   - データ共有設定：内容を確認し、共有する項目をチェック
3. プロパティを作成し、次へを押す

   creategoogleanalyticsaccount-2
...
4. ビジネスの詳細を設定し、次へを押す
   ...
   creategoogleanalyticsaccount-3

   - 業種：当てはまるものを選択
   - ビジネスの規模：当てはまるものを選択
5. ビジネス目標を選択し、作成を押す

   creategoogleanalyticsaccount-4
6. データの収集を開始するで「ウェブ」を選択

   creategoogleanalyticsaccount-5
7. データストリームの設定を行いストリームを作成を押す

   creategoogleanalyticsaccount-6
...
## part-4/application-settings/googletagmanagersetting/googleanalyticsgoogletagmanagerlink.md
...
5. 測定IDが表示されるので確認する
   ...
   googleanalyticsgoogletagmanagerlink-1

## 2. Google Tag ManagerでGoogle Analyticsを設定

1. Google Tag Managerのホームページにアクセス
2. 「新しいタグを追加」を押す

   googleanalyticsgoogletagmanagerlink-2
3. 「タグの設定」から「Googleアナリティクス」> 「Googleタグ」を選択

   googleanalyticsgoogletagmanagerlink-3
4. タグIDにGoogle Analyticsの測定IDを入力

   googleanalyticsgoogletagmanagerlink-4
5. トリガーにInitialization - All Pagesを選択

   googleanalyticsgoogletagmanagerlink-5
6. 左上の入力項目にタグの名前を入力し、保存を押す
7. コンテナページ右上の公開を押す

   googleanalyticsgoogletagmanagerlink-6
8. バージョンの公開と作成の項目を入力し公開を押す

   googleanalyticsgoogletagmanagerlink-7
...
なお、Google Analyticsへの反映は24~48時間かかる場合があります。詳細はGoogle Analyticsのドキュメントをご確認ください。
````


---

## part-4/application-settings/googletagmanagersetting/googletagmanagercontaineridsetting.md
...
googletagmanagercontaineridsetting-1

### コンテナページから確認

画面右上の「GTM-XXXXXXXX」を確認してください。

googletagmanagercontaineridsetting-2

## 2. コンテナIDを設定

1. SaaS開発コンソールの「認証詳細設定」を開く

   googletagmanagercontaineridsetting-3
2. 認証詳細設定画面の「基本設定」最下部にある「Google Tag Manager コンテナ ID」にコンテナIDを設定し保存ボタンを押す

   googletagmanagercontaineridsetting-4
...
## part-4/application-settings/googletagmanagersetting/googletagmanagercreateaccountandcontainer.md
...
2. 「アカウントを作成」ボタンを押す
   ...
   googletagmanagercreateaccountandcontainer-1
3. 「アカウントの設定」及び「コンテナの設定」項目を入力し、「作成」を押す
   ...
   googletagmanagercreateaccountandcontainer-2
...
2. コンテナ一覧の右側のドットメニューから「コンテナを作成」を押す
   ...
   googletagmanagercreateaccountandcontainer-3
3. 「コンテナの設定」項目を入力し、右上の「作成」を押す

   - コンテナ名：任意
   - ターゲットプラットフォーム：ウェブ

   googletagmanagercreateaccountandcontainer-4
...
## part-4/application-settings/ip-restriction.md
...
## part-4/aws-marketplace-integration/aws-marketplace-integration.md
...
・SaaSus Platformの認証詳細設定でセルフサインアップを有効にしている (参考)  
・ユーザー自身がSaaS上で契約しているプランを確認できるようになっている  
・ユーザー自身がSaaS上でサポートへ問い合わせできる動線が配置されている  
・既にアカウントを持っているユーザーがSaaSを購入した時のマルチテナントの考慮を実装している (参考)  
・AWS Marketplaceから購入したユーザーは、SaaS上ではプランの変更、退会をできないようにしている (参考)
````


---

## part-4/aws-marketplace-integration/aws-marketplace-seller-registration.md
...
## part-4/aws-marketplace-integration/aws-marketplace-seller-registration/aws-marketplace-seller-registration.md

````markdown

AWS Marketplaceへ出品者として登録をします。 

上記リンクで表示されるページの`Register now`から登録を開始してください。

aws-marketplace-seller-registration-1

AWS Marketplaceのセラー登録の画面へ遷移しますので、  
商号、利用規約、登録者の情報を設定して登録してください。

aws-marketplace-seller-registration-2

aws-marketplace-seller-registration-3


入力が完了後、登録ボタンを押下してください。

aws-marketplace-seller-registration-4


aws-marketplace-seller-registration-5


登録後はPublic profileの設定に進みます。

aws-marketplace-seller-registration-6
````


---

## part-4/aws-marketplace-integration/aws-marketplace-seller-registration/dac7-tax-survey.md
...
## part-4/aws-marketplace-integration/aws-marketplace-seller-registration/public-profile-settings.md

````markdown
セラー登録後、AWS Marketplace Management PortalにログインしてPublic profileを設定します。  
Settingsの`Add public profile`から設定を始めてください。


public-profile-settings-1


ここで設定する内容は、AWS Marketplaceで公開される企業情報（Public profile）となります。

public-profile-settings-2


企業情報を設定後、送信ボタンを押下して設定します。

public-profile-settings-3

Public profileの設定が完了した後は、銀行口座の設定を始めてください

public-profile-settings-4
````


---

## part-4/aws-marketplace-integration/aws-marketplace-seller-registration/register-bank-account.md

````markdown
続いて`Payment Information`より`Add bank account`を押下してください。  

new-register-bank-account-1
...
new-register-bank-account-3


次に、請求先住所を入力します。

new-register-bank-account-4

全ての入力を終えたら、`Add bank account`を押下します。

new-register-bank-account-5

問題なければ、`Payment Information`にて追加した銀行口座をご確認いただけます。

new-register-bank-account-6
...
## part-4/aws-marketplace-integration/aws-marketplace-seller-registration/register-disbursement-methods.md

````markdown

:::caution
あらかじめ銀行口座の設定が完了していることをご確認ください。
まだお済みでない場合は、銀行口座の設定を参考に設定を行ってください。
:::

`Payment Information`より`Add disbursement method`を押下してください。

new-register-disbursement-methods-1

最初に、支払われる通貨を選択します。利用可能な通貨は公式ドキュメントを参照してください。

new-register-disbursement-methods-2

次に、支払いを受け取る銀行口座を選択します。銀行口座の設定で追加した銀行口座の中で、直前に選択した通貨に対応している銀行口座が選択肢として選べるようになっています。

new-register-disbursement-methods-3
...
new-register-disbursement-methods-4

全ての入力を終えたら、`Add disbursement method`を押下します。

new-register-disbursement-methods-5

問題なければ、`Payment Information`にて追加した支払い方法をご確認いただけます。

new-register-disbursement-methods-6
...
## part-4/aws-marketplace-integration/aws-marketplace-seller-registration/tax-information-interview.md

````markdown

## 日本を拠点とするお客様の場合

AWS Marketplace Management PortalのSettingsページから

`Payment Information`を確認してください。  
以下のようにエラーが表示され、先の手続きを進めることができないと思います。

tax-information-interview-1


解消する方法については、JP SOR FAQに載っており、それについて抜粋したものが以下になります。

tax-information-interview-2


## 日本を拠点とするお客様が行う手続き

上記より、まずはaws-jp-marketplace@amazon.co.jpに対してAWS Marketplaceへ掲載する旨をメールでお伝えください。アマゾン ウェブ サービス ジャパン合同会社より、返信が返ってきますので指示に従い、追加情報を提出してください。アマゾン ウェブ サービス ジャパン合同会社との手続きが終わると、AWS Marketplace Management PortalのSettingsページの`Payment Information`が表示されるようになります。

## 始めに行うこと（税務情報に関するインタビュー）

AWS Marketplace Management PortalのSettingsページから、`Payment Information`を開いてください。

`Go to tax dashboard`を押下して税務情報に関するインタビューの入力を始めます。

tax-information-interview-3


`Select Language`にて`Japanese`を選択することで日本語表記で入力を進めることが出来ます。

tax-information-interview-4


税務情報に関するインタビューで`開始`ボタンを押下します。

tax-information-interview-5


質問項目を入力していきます。

tax-information-interview-6


税務上の身元情報の設定

tax-information-interview-7

tax-information-interview-8


署名（氏名を入力）しプレビューにて内容を確認します。

tax-information-interview-9


**米国で課税されないように、日本の納税者である事を申告するフォーム**

tax-information-interview-10


内容確認後、`フォームを送信`ボタンを押下し提出します。

tax-information-interview-11


送信完了し、税務情報に関するインタビューを終了します。

tax-information-interview-12
````


---

## part-4/aws-marketplace-integration/embedding-products.mdx
...
３．選択したアカウントに対してSAASUS AUTH APIのLinkAwsMarketplaceを実行
...
## part-4/aws-marketplace-integration/product-submission.md

````markdown
AWS Marketplace Management Portalにて、SaaS製品情報を登録します。

:::caution
本手順を実施する前にセラー登録から支払い方法の設定の手続きが完了していることをご確認ください。
:::
...
入力内容等は `AWS Marketplace` 上で公開されます、各入力内容と表示例はこちらをご確認ください。（補足１）（補足２）
````


---

## part-4/aws-marketplace-integration/product-submission/generate-product-code.md

````markdown
SaaS製品情報を登録するには、まずAWS Marketplace Management Portalにアクセスしていただき、以下の手順で登録を進めてください。
...
## part-4/aws-marketplace-integration/product-submission/step1-provide-product-information.md
...
各入力項目の制限やAWS Marketplace上にどのように公開されるかは補足資料を用意していますので、ご確認ください。公開例、入力項目の詳細
:::
...
## part-4/aws-marketplace-integration/product-submission/step2-configure-fulfillment-options.md
...
AWS Marketplace連携機能ページから出品手続きを開始していただき、`ステップ1-4:SaaS製品情報の登録`まで進めていだたくと指示書を確認できるようになります。
...
## part-4/aws-marketplace-integration/product-submission/step3-configure-product-pricing.md
...
## part-4/aws-marketplace-integration/product-submission/step4-set-prices.md
...
## part-4/aws-marketplace-integration/product-submission/step5-specify-refund-policy.md
...
AWS Marketplace上でSaaS製品を販売する際の返金について補足するドキュメントがありますので、ご一読ください。
:::
...
## part-4/aws-marketplace-integration/product-submission/step6-configure-eula.md
...
AWS Marketplace側で事前に用意しているEULAはこちらです。
:::
...
## part-4/aws-marketplace-integration/product-submission/step7-configure-offer-availability.md
...
## part-4/aws-marketplace-integration/product-submission/step8-configure-allowlist.md
...
## part-4/aws-marketplace-integration/supplementary.md
...
## part-4/aws-marketplace-integration/supplementary/final-review-request.md

````markdown
出品手順「10. AWS Marketplaceとの連携確認」が完了したら、AWS Marketplaceサポートチームへ最終レビューの依頼を行います。

まずAWS Marketplace Management Portalにアクセスしていただき、対象のプロダクト詳細ページを開きます。

次に画面上部に表示されているアラートの右側の`Update visibility`を押下します。

final-review-request-1

遷移後にVisibility optionsを`public`に設定します。

final-review-request-2


追加で契約金額を入力するフォームが追加で表示されるので、正規の金額を入力した後`Submit`を押下します。

final-review-request-3
...
> 📘 補足事項
> 
> AWS Marketplace 販売者オペレーション チームによって製品の検証と公開が行われます。約 7 ～ 10 営業日ほどで公開されます。詳しくはこちら
````


---

## part-4/aws-marketplace-integration/supplementary/integration-test.md
...
## part-4/aws-marketplace-integration/supplementary/public-request.md

````markdown
出品手順「11. 本番用SaaS製品の最終レビュー依頼」が完了後、AWS Marketplaceサポートチームから公開依頼する手順について説明するメールが届きますので、それを元に公開依頼を行います。
...
1. AWS Marketplace Management Portalにアクセスします
...
## part-4/aws-marketplace-integration/supplementary/self-up-setting.md

````markdown
1. SaaS 開発コンソールの認証詳細設定にアクセスします。
...
## part-4/aws-marketplace-integration/supplementary/supplementary-1.md
...
## part-4/aws-marketplace-integration/supplementary/supplementary-2.md

````markdown
こちらで入力した内容は「Create Productの入力内容と公開される内容について」にて  
...
| 入力項目                | 説明                                                                                                                                                                                                                                                                              | 必須 | 入力種別       | 入力制限                        |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -- | ---------- | --------------------------- |
| Dimension unit type | 製品の使用単位カテゴリを設定(**SaaSus Platformで出力された入力指示書に従い内容を設定してください**) | 必須 | Select Box | 選択肢から選ぶ（9種類）                |
...
## part-4/aws-marketplace-integration/supplementary/supplementary-3.md

````markdown
1. AWS マネジメントコンソールへログインします。
2. こちらのリンク へアクセスしてください。
...
## part-4/aws-marketplace-integration/supplementary/user-judgment-method.md

````markdown
SAASUS AWS MARKETPLACE APIを利用します。

GetCustomersというエンドポイントを利用します。仕様はドキュメントを参照してください。
...
## part-4/integrate-with-amazon-eventbridge.md
...
## part-4/integrate-with-amazon-eventbridge/event-sample.md
...
## part-4/mcp-server/bulk-user-registration.md
...
## part-4/mcp-server/clone-dev-settings.md
...
## part-4/mcp-server/environment-setup-guide.md
...
本手順は チュートリアルを進める前に必要な設定 、 SaaS 利用者テナントの作成、SaaS 利用ユーザーの作成 、料金プラン設定の手順、テナントへの料金プランの適用 で必要な項目を作成しています。
...
## 環境作成
本手順は チュートリアルを進める前に必要な設定 を元に行なっております。
...
## テナント作成
本手順は SaaS 利用者テナントの作成を元に行なっております。
...
## ユーザー作成
本手順は SaaS 利用ユーザーの作成 を元に行なっております。
...
## 料金プラン
本手順は 料金プラン設定の手順 、テナントへの料金プランの適用 を元に行なっております。
...
## part-4/mcp-server/export-metering-data.md
...
## part-4/mcp-server/export-tenant-contract-info.md
...
## part-4/mcp-server/export-user-info-csv.md
...
## part-4/mcp-server/user-behavior-analysis.md
...
## part-4/pricing-and-billing/pricing-plan-creation.md
...
## part-4/pricing-and-billing/pricing-plan-overview.md
...
## part-4/pricing-and-billing/stripe-integration.md
...
## part-4/pricing-and-billing/tax-rate-settings.md
...
## part-4/pricing-and-billing/tiered-unit.md
...
## part-4/pricing-and-billing/usage-metering.md
...
## part-4/saas-development-console-overview.md
...
## part-4/saas-infra-management.md
...
## part-4/smart-api-gateway-features/manual.mdx
...
## part-4/smart-api-gateway-features/overview.md
...
Smart API Gateway by SaaSus Platform サポート申請フォーム<br/>
:::
...
api-gateway-function/api-gateway-function-2

### Smart API Gateway アーキテクチャ

API に必要な機能を提供し、既存の処理をほぼそのまま API としてセキュアに公開することができます。

api-gateway-function/api-gateway-function-1
...
## part-4/smart-api-gateway-features/smart-mcp-server-overview.mdx
...
Smart MCP Server by SaaSus Platform サポート申請フォーム
:::
...
3. **MCP Server** を選択します
  smart-mcp-server-tutorial-4
4. **Add New** を選択します
  smart-mcp-server-tutorial-5
5. 表示されたフォームにそれぞれ値を入力します：
  ...
  - **Authentication** : **Custom headers** を選択
    - キー : **x-api-key**
    - 値 : **控えておいた**APIキー**
  smart-mcp-server-tutorial-6
6. **Connect**を押下します
7. 成功するとToolsに利用可能なAPI一覧が表示されます
　smart-mcp-server-tutorial-7
8. **Add**を押下します
9. **Tools** セクションに追加したMCP Serverが表示されていることを確認します
　smart-mcp-server-tutorial-8
...
:::info
Smart MCP Server機能に関するご質問やサポートが必要な場合は、サポート申請フォームからお問い合わせください。
:::
...
## part-4/user-authz-settings/authentication-method-settings.md
...
詳しい手順は、Google連携の設定手順 を参照してください。
...
具体的なAPIの使い方や実装例は、多要素認証の実装 を参照してください。
:::
...
## part-4/user-authz-settings/declare-additional-attribute-to-user.md
...
## part-4/user-authz-settings/google-linkage.md
...
- SaaSus Platformでドメインの設定 が完了していることを確認
...
## part-4/user-authz-settings/notifymailcustomize.md

````markdown

認証詳細設定画面の通知メール内容タブでは、ログイン画面などの認証系ページでユーザーに送信するメールをカスタマイズすることができます。
...
## part-4/user-authz-settings/role-definition.md
...
## part-4/user-authz-settings/saml-linkage.md
...
## part-4/user-authz-settings/user-env-definition.md
...
user-env-definition-2

ID、環境名、表示名を設定します。IDは一意となるように設定してください。

user-env-definition-3

登録した環境が表示されます。

## ユーザー環境定義の更新と削除

user-env-definition-4

環境名、表示名が変更することができます。

user-env-definition-5
...
## part-5/operations-console-overview.md
...
## part-5/price-plan/price-plan-setting-000.md
...
## part-5/price-plan/price-plan-setting-001.md
...
**税率設定についてはこちらのドキュメントを参照してください。（税率設定）**
...
## part-5/price-plan/price-plan-setting-002.md
...
## part-5/price-plan/price-plan-setting-003.md
...
## part-5/price-plan/price-plan-setting-004.md
...
## 使用方法
この機能を使うためには、Communication APIを使用してフィードバックを操作する機能をSaaSに実装する必要があります。
...
## part-5/user-management/user-activity-history-log.md
...
例えば `Express` を使用する場合、以下のようになります。
...
例えば `FastAPI` を使用する場合、以下のようになります。
...
## part-5/user-management/user-crud.md
...
## part-6/developer-sdk-api-overview.md
...
1. 署名付きで GET /v1/auth/credentials を呼び、`id_token`・`access_token`・`refresh_token` を取得します。
...
| **メータリング関連** | Pricing API – metering タグ一覧 | メータリングAPI実装サンプル |
...
## part-6/implementation-guide/implementing-authentication-using-saasus-serverless.md
...
## part-6/implementation-guide/sample-application/activity-history-log.md
...
## part-6/implementation-guide/sample-application/authentication.md
...
- **Go (Echo)**: `getCredentials`
- **Python (FastAPI)**: `get_credentials`
- **Java (Spring)**: `getCredentials`
- **C# (.NET 8)**: `app.MapGet("/credentials"`
- **C# (.NET Framework 4.8)**: `GetCredentials`
...
- **Go (Echo)**: `getMe`
- **Python (FastAPI)**: `get_user_info`
- **Java (Spring)**: `getMe`
- **C# (.NET 8)**: `app.MapGet("/userinfo"`
- **C# (.NET Framework 4.8)**: `GetUserInfo`

このAPIは内部でSaaSus APIのユーザ情報取得を呼び出しています。レスポンスデータの詳細な活用方法については、SaaSus API ユーザ情報取得 レスポンスデータをご参照ください。
...
- **Go (Echo)**: `selfSignup`
- **Python (FastAPI)**: `self_signup`
- **Java (Spring)**: `selfSignUp`
- **C# (.NET 8)**: `app.MapPost("/self_sign_up"`
- **C# (.NET Framework 4.8)**: `SelfSignUp`
...
- **Go (Echo)**: `getUsers`
- **Python (FastAPI)**: `get_tenant_users`
- **Java (Spring)**: `getUsers`
- **C# (.NET 8)**: `app.MapGet("/users"`
- **C# (.NET Framework 4.8)**: `GetUsers`
...
ユーザ情報取得APIのレスポンスには、テナント情報（tenants）、環境情報（envs）、役割情報（roles）がそれぞれ配列として含まれており、
...
## part-6/implementation-guide/sample-application/billing-dashboard.md
...
- **Go (Echo)**: `getPlanPeriods`
- **Python (FastAPI)**: `get_plan_periods`
- **Java (Spring)**: `getPlanPeriods`
- **C# (.NET 8)**: `GetPlanPeriods`
- **C# (.NET Framework 4.8)**: `GetPlanPeriods`
...
- **Go (Echo)**: `getBillingDashboard`
- **Python (FastAPI)**: `get_billing_dashboard`
- **Java (Spring)**: `getBillingDashboard`
- **C# (.NET 8)**: `GetBillingDashboard`
- **C# (.NET Framework 4.8)**: `GetBillingDashboard`
...
- **Go (Echo)**: `updateCountOfNow`
- **Python (FastAPI)**: `update_count_of_now`
- **Java (Spring)**: `updateCountOfNow`
- **C# (.NET 8)**: `UpdateMeteringCountNow`
- **C# (.NET Framework 4.8)**: `UpdateMeteringCountNow`
...
- **Go (Echo)**: `updateCountOfSpecifiedTS`
- **Python (FastAPI)**: `update_count_of_specified_timestamp`
- **Java (Spring)**: `updateCountOfSpecifiedTimestamp`
- **C# (.NET 8)**: `UpdateMeteringCount`
- **C# (.NET Framework 4.8)**: `UpdateMeteringCount`
...
## part-6/implementation-guide/sample-application/metering-api.md
...
## part-6/implementation-guide/sample-application/multi-factor-authentication.md
...
- **React**: `UserMfaSettingDialog.tsx` - MFA設定ダイアログコンポーネント
- **React**: `HeaderUserbox.tsx` - ヘッダーユーザーメニュー
...
- **Go (Echo)**: `getMfaStatus`
- **Python (FastAPI)**: `get_mfa_status`
- **Java (Spring)**: `getMfaStatus`
- **C# (.NET 8)**: `app.MapGet("/mfa_status"`
- **C# (.NET Framework 4.8)**: `GetMfaStatus`
...
- **Go (Echo)**: `getMfaSetup`
- **Python (FastAPI)**: `get_mfa_setup`
- **Java (Spring)**: `getMfaSetup`
- **C# (.NET 8)**: `app.MapGet("/mfa_setup"`
- **C# (.NET Framework 4.8)**: `SetupMfa`
...
- **Go (Echo)**: `verifyMfa`
- **Python (FastAPI)**: `verify_mfa`
- **Java (Spring)**: `verifyMfa`
- **C# (.NET 8)**: `app.MapPost("/mfa_verify"`
- **C# (.NET Framework 4.8)**: `VerifyMfa`
...
- **Go (Echo)**: `enableMfa`
- **Python (FastAPI)**: `enable_mfa`
- **Java (Spring)**: `enableMfa`
- **C# (.NET 8)**: `app.MapPost("/mfa_enable"`
- **C# (.NET Framework 4.8)**: `EnableMfa`
...
- **Go (Echo)**: `disableMfa`
- **Python (FastAPI)**: `disable_mfa`
- **Java (Spring)**: `disableMfa`
- **C# (.NET 8)**: `app.MapPost("/mfa_disable"`
- **C# (.NET Framework 4.8)**: `DisableMfa`
...
## part-6/implementation-guide/sample-application/overview.md
...
#### `UserMfaSettingDialog.tsx` - 多要素認証設定ダイアログ
...
- **Go (Echo)**: セットアップ手順
- **Python (FastAPI)**: セットアップ手順
- **Java (Spring)**: セットアップ手順
- **C# (.NET)**: セットアップ手順
...
## part-6/implementation-guide/sample-application/plan-change-implementation.md
...
## part-6/usecase/about-rate-plans.md
...
Individual プラン、Enterprise プランのメーター単位・計測単位・機能メニュー・料金プランの設定の設定内容(画像)はこちらを参照 
...
## part-6/usecase/about-rate-plans/basic-charge-preference.md
...
## part-6/usecase/about-saas-user-accounts.mdx
...
SaaSにユーザー登録ができたら、登録者のUserInfo配列内の tenants からテナント情報を取得し、テナントにユーザーを紐づけロールを設定してみましょう。
...
## part-6/usecase/about-saas-user-accounts/add-tenant-user.mdx
...
```php
        ...
        $auth_api_client->createTenantUserRoles($tenant->getId(), $request'userinfo', getenv('DEFAULT_SAASUSER_ENV'), $create_tenant_user_roles_param);
```
...
## part-6/usecase/about-saas-user-accounts/create-tenant.mdx
...
## part-6/usecase/authentication-methods.mdx
...
## reference/awsmarketplace-api.mdx
...
## reference/communication-api.mdx
...
## reference/getting-started-with-your-api.md
...
📋 SaaSus API Postman をパブリックワークスペースからフォークを作成してください。
...
## tutorial/authentication-preference.mdx
...
```php
   public function index(Request $request)
   {
       ...
       $messages = Message::where('tenant_id', $request->userinfo'tenants'['id'])->get();
       return view('messageBoard.index', 'messages' => $messages, 'plans' => $this::PLANS, 'tenant_name' => $request->userinfo['tenants'['name']]);
   }
```
...
```php
   public function post(Request $request)
   {
       ...
       $message = Message::create([
            'tenant_id' => $request->userinfo'tenants'['id'],
            'user_id' => $request->userinfo'tenants''user_attribute',
...
## tutorial/configuring-sdk-for-saasus-platform.mdx
...
## tutorial/implementation-of-authorization-based-on-tenant-information.mdx
...
```php
   public function post(Request $request)
   {
        ...
        $tenant_id = $request->userinfo'tenants'['id'];
        $plan_id = $request->userinfo'tenants'['plan_id'];
        ...
        if ($count['count'] < $upper || $upper === 0) {
            ...
            $param->setMethod('add');
            $param->setCount(1);
            $res = $pricingApi->updateMeteringUnitTimestampCountNow($request->userinfo'tenants'['id'], $meteringUnitName, $param, $pricingApi::FETCH_RESPONSE);
        }
...
そして、テナント１の方にはFreeプランを設定し、user1-1@example.com でログインして、１０件以上の書き込みを行ってみましょう。
...
では、次にテナント２のユーザー user2-1@example.com でログインして、１０件以上の書き込みを行ってみましょう。

こちらは上限が100件になっているので、１０件以上の書き込みができたはずです。



さらに、テナント１の方がプランのアップグレードをした想定で、FreeプランからBasicプランに設定を変更して、再度 user1-1@example.com でログインして、１０件以上の書き込みを行ってみましょう。  
...
## tutorial/manage-rate-plans/manage-rate-plans.md
...
## tutorial/manage-rate-plans/setting-measurement-units-function-menus-and-price-plans.md
...
## tutorial/prepare-saasus-platform.md
...
## tutorial/prepare-the-sample-application-ec2.md
...
## tutorial/prepare-the-sample-application.md
...
AWS の EC2 や Cloud9 を利用して、Blade 版の動作環境を作成する場合は、サンプルアプリケーションの準備(EC2)の手順で行ってください。
...
実装ガイドには、各項目の詳細な設定方法も記載しておりますので、ぜひご参考にしてください。
...
paths:
  ...
  /settings/open-api-definition:
    put:
      tags:
        - smartApiGateway
      operationId: UpdateOpenApiDefinition
      summary: OpenAPI定義ファイルを更新
      description: |
        OpenAPI定義ファイルを更新します。OpenAPI定義ファイルは、自動生成されるドキュメントに使用されます。
      requestBody:
        required: true
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/UpdateOpenApiDefinitionParam"
      responses:
        "200":
          description: OK
        "500":
  ...
  /draft/settings:
    get:
      tags:
        - smartApiGateway
      operationId: GetDraftApiGatewaySettings
      summary: Smart API Gatewayのドラフト設定情報を取得
      description: |
        Smart API Gatewayのドラフト設定情報を取得します。
        アップロードしたソースコードから生成された設定を、適用する前に確認することができます。
      responses:
        "200":
          description: OK
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/DraftApiGatewaySettings"
        "500":
          description: Internal Server Error
          content:
            application/json:
  ...
  /draft/settings/apply:
    post:
      tags:
        - smartApiGateway
      operationId: ApplyDraftApiGatewaySettings
      summary: Smart API Gatewayのドラフト設定情報を適用
      description: |
        Smart API Gatewayのドラフト設定情報を適用します。
        ドラフト設定で行った変更を実際のSmart API Gatewayに反映します。
      responses:
        "200":
          description: OK
        "500":
  ...
  /draft/settings/cancel:
    post:
      tags:
        - smartApiGateway
      operationId: CancelDraftApiGatewaySettings
      summary: Smart API Gatewayのドラフト設定情報をキャンセル
      description: |
        Smart API Gatewayのドラフト設定情報をキャンセルします。
        ドラフト設定で行った変更を実際のSmart API Gatewayに反映せずにキャンセルします。
      responses:
        "200":
          description: OK
        "500":
  ...
  "/api-keys/{api_key}/client-secret":
    post:
      ...
      summary: APIキーのクライアントシークレットを更新
      description: |
        APIキーのクライアントシークレットを更新します。
      parameters:
        - in: path
          name: api_key
          description: APIキー
  ...
  schemas:
    ...
    ApiGatewaySettings:
      ...
      properties:
        ...
        docs_cloud_front_fqdn:
          title: Smart API Gatewayドキュメント用のCloudFront FQDN
          description: Smart API Gatewayドキュメント用のCloudFront FQDN
          type: string
          example: 0123456789abc.cloudfront.net
        mcp_server_url:
          title: MCPサーバーURL
          description: Smart API Gateway用のMCP（Model Context Protocol）サーバーのURL
          type: string
      ...
      properties:
        ...
        role_names:
          ...
          items:
            ...
            example: admin
        mapping_endpoint_id:
          title: マッピングエンドポイントID
          description: APIコール時に実行される関数を識別するためのID
          type: string
          example: implementsample.service.UserService/getById
      required:
        - path
        - method
        - throttlings
    ...
    UpdateOpenApiDefinitionParam:
      title: OpenAPI定義更新パラメータ
      type: object
      properties:
        content:
          title: OpenAPI定義ファイルのコンテンツ
          description: OpenAPI定義ファイルのコンテンツ
          type: string
          format: base64
          example: UEsDBBQACAAIAJr6oFQmTAuRfvOGAA==
      required:
...
paths:
      ...
      responses:
        "201":
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/CreatedSaasUser"
        "400":
          description: Bad Request
          content:
            application/json:
    ...
    patch:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/UpdateRoleParam"
      responses:
        "200":
          description: OK
        "400":
    ...
    post:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/ConfirmDeviceParam"
      responses:
        "200":
          description: OK
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/ConfirmDeviceResult"
        "400":
          description: Bad Request
          content:
            application/json:
    ...
    post:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/UpdateDeviceStatusParam"
      responses:
        "200":
          description: OK
        "400":
    ...
    post:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/RespondToSignInChallengeParam"
      responses:
        "200":
          description: OK
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/RespondToSignInChallengeResult"
        "401":
          description: Unauthorized
          content:
            application/json:
  ...
  /single-tenant/cloudformation-launch-stack-link:
    get:
      ...
      summary: SaaSインフラ管理用CloudFormationスタック起動リンク取得
      description: |
  ...
  /single-tenant/settings:
    get:
      ...
      summary: SaaSインフラ管理機能の設定情報を取得する
      responses:
        "200":
          description: OK
          content:
    ...
    patch:
      ...
      summary: SaaSインフラ管理機能の設定情報を更新する
      description: |
        SaaSインフラ管理機能の設定情報を更新します。
        SaaSインフラ管理機能の有効化ができない場合はエラーを返します。
      requestBody:
        content:
          application/json:
            schema:
...
components:
  ...
  schemas:
    ...
    SaasUser:
      ...
      properties:
        ...
        email:
          ...
          description: |
            メールアドレス。
            ログインID認証ユーザーの場合は設定されません。
        sign_in_id:
          type: string
          example: user123
          description: |
            ログインID。
            メールアドレス認証ユーザーの場合は設定されません。
        attributes:
          type: object
          additionalProperties: true
          example:
        ...
        - type: object
          properties:
            password:
              type: string
              description: |
                自動生成されたパスワード（ログインID認証かつパスワード未指定の場合のみ）
      example:
        id: 69e732d6-8ecc-45c4-c2eb-8438f7ffe775
        email: ""
    ...
    CreateSaasUserParam:
      ...
      type: object
      description: |
        emailまたはsign_in_idのどちらか一方を指定します。両方指定することはできません。
        - emailを指定した場合: メールアドレス認証ユーザーが作成されます。
          passwordを指定しない場合、仮パスワードがメールで送信されます。
        - sign_in_idを指定した場合: ログインID認証ユーザーが作成されます。
          passwordを指定しない場合、自動生成され、レスポンスに含まれます。
      properties:
        email:
          type: string
          example: hoge@example.com
    ...
    UpdateSaasUserPasswordParam:
      ...
      properties:
        ...
        temporary:
          type: boolean
          description: true を指定すると新しいパスワードを一時パスワードとして設定します（次回サインイン時に変更が必要）
      required:
        - password
    ...
    PlanReservation:
      ...
      properties:
        ...
        using_next_plan_from:
          ...
          example: 1640995200
          description: >
            このパラメータは、料金プランの変更を将来の日時で予約する場合に設定します。即時反映の場合は設定不要です。

            次回の料金プラン開始日時を指定する際は、現在時刻より5分後以降の日時を指定してください。

            Stripe連携時の注意点: 当月の月初（0時 UTC）を開始日時として指定すると、その月の初日から開始されるサブスクリプションを作成できます。 （例: 2023年1月1日 00:00 UTC を指定する場合 → 1672531200）
    ...
    UpdateIdentityProviderParam:
      ...
      properties:
        ...
        identity_provider_props:
          description: identity_provider_propsがnullの場合は、providerで指定された外部IDプロバイダのサインイン情報を無効化する。
          $ref: "#/components/schemas/IdentityProviderProps"
      required:
        - provider
    ProviderName:
    ...
    SingleTenantSettings:
      ...
      properties:
        enabled:
          title: SaaSインフラ管理設定を有効にするか否か
          description: SaaSインフラ管理設定を有効にするか否か
          type: boolean
        role_arn:
          title: AssumeRoleするためのロールのARN
        ...
        ddl_template_url:
          title: ddlテンプレートURL
          description: S3 URL where the ddlTemplate to be executed in the SaaS environment
            is stored
          type: string
          example: https://presigned-url-test.s3.ap-northeast-1.amazonaws.com/test.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=xxxxxx%2F20230710%2Fap-northeast-1%2Fs3%2Faws4_request&X-Amz-Date=20230710T054140Z&X-Amz-Expires=604800&X-Amz-SignedHeaders=host&X-Amz-Signature=xxxxxxxxxxxxxxxx
        role_external_id:
    ...
    SignInResult:
      ...
      properties:
        ...
        session:
          ...
          description: |
            チャレンジのセッション識別子。
            もし次のチャレンジが必要な場合、このセッションを次回のRespondToSignInChallengeの呼び出しに渡す必要があります。
          type: string
    ChallengeName:
      title: チャレンジ名
      description: チャレンジ名
    ...
    RespondToSignInChallengeParam:
      title: ログインチャレンジ応答パラメータ
      description: |
        ログインチャレンジに応答するために必要なパラメータ
      type: object
      properties:
        challenge_name:
          $ref: "#/components/schemas/ChallengeName"
    ...
    RespondToSignInChallengeResult:
      ...
      properties:
        ...
        session:
          ...
          type: string
        new_device_metadata:
          $ref: "#/components/schemas/NewDeviceMetadata"
    NewDeviceMetadata:
      title: 新規デバイスメタデータ
      description: |
        認証中に登録された新規デバイスのメタデータ。
      type: object
      properties:
        device_key:
          title: デバイスキー
          description: デバイスキー識別子
          type: string
        device_group_key:
          title: デバイスグループキー
          description: デバイスグループキー識別子
          type: string
    DeviceSecretVerifierConfig:
      title: デバイスシークレット検証設定
      description: |
        デバイスシークレット検証の設定。
      type: object
      properties:
        password_verifier:
          title: パスワード検証子
          description: ユーザーデバイスのパスワード検証子。SRP認証に使用されます。
          type: string
        salt:
          title: ソルト
          description: ユーザーデバイスとのSRP認証に使用するソルト。
          type: string
    ConfirmDeviceParam:
      title: デバイス確認パラメータ
      description: |
        デバイスを確認するために必要なパラメータ。
      type: object
      properties:
        access_token:
          title: アクセストークン
          description: 有効なアクセストークン。
          type: string
        device_key:
          title: デバイスキー
        ...
        device_name:
          title: デバイス名
          description: デバイスのフレンドリー名。
          type: string
        device_secret_verifier_config:
          $ref: "#/components/schemas/DeviceSecretVerifierConfig"
      required:
        - access_token
        - device_key
    ConfirmDeviceResult:
      ...
      properties:
        user_confirmation_necessary:
          title: ユーザー確認の要否
          description: |
            trueの場合、ユーザーがデバイスを記憶するか確認する必要があります。
            falseの場合、デバイスは即座に記憶されます。
          type: boolean
      required:
        - user_confirmation_necessary
    ...
    UpdateDeviceStatusParam:
      title: デバイスステータス更新パラメータ
      description: |
        デバイスのステータスを更新するために必要なパラメータ。
      type: object
      properties:
        access_token:
          title: アクセストークン
        ...
        device_remembered_status:
          $ref: "#/components/schemas/DeviceRememberedStatus"
      required:
        - access_token
        - device_key
        - device_remembered_status
