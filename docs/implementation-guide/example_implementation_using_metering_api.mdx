...
<details><summary><b>Creating the Pricing Plan for This Implementation Example</b></summary>

## Creating the Pricing Plan

### Creating Measurement Units

We will create measurement units for the number of users and active users.
...
<!-- TODO fix link url -->
<a href="doc:tiered_unit">About the Difference in Billing Calculation between Tiered Units and Tiered Usage Units</a>

1. Go to Pricing Plan -> Measurement Unit Settings from the development console.
2. In the Measurement Unit Settings screen, click the "▼" next to "Create Fixed Unit Measurement" and select "Create Usage Unit Measurement", then click the "Create Usage Unit Measurement" button.

   ![](/img/metering-api-sample/image-03.png)
3. Set the measurement units for the number of users and active users.
...
Create feature menus to set the created measurement units.

1. Go to Pricing Plan -> Feature Menu Settings from the development console.
2. Click on "Create Feature Menu" at the top right.
3. Create a feature menu with the measurement units for the number of users and active users set.
...
<details><summary><b>React Implementation Sample</b></summary>
...
const METERING_UNIT_NAME_DICT_ARRAY = [
    {
        ...
        displayName: 'ユーザー数', // Display name for user count
    },
    {
        key: 'active_user_count', // Target meter name for active user count defined in the pricing plan creation
        displayName: 'アクティブユーザー数', // Display name for active user count
    },
]
...
<details><summary><b>Laravel Implementation Sample</b></summary>
...
Implementing the sample code will create a feature as shown in the image below.

![](/img/metering-api-sample/metering_system_example.gif)
