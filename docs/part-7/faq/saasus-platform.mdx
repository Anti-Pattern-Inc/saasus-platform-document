...
updatedAt: "Fri Jul 03 2026 08:28:00 GMT+0000 (Coordinated Universal Time)"
---
...
**Q. Can I switch back (downgrade) from the Starter plan to the Free plan?**

A. Under the current specifications, you cannot directly switch back (downgrade) from the Starter plan to the Free plan.  
To switch to the Free plan, you need to follow the steps below.

1. **Cancel your current Starter plan**
...
**Q. How do I upgrade from the Free plan to a paid plan such as the Starter plan?**
...
You can also apply via AWS Marketplace. In this case, the contract is handled as a Private Offer, so please contact our support team.
