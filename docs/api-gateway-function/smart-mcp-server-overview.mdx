...
<details>
<summary>📋 Smart MCP Server Feature Beta Tutorial (Click to expand)</summary>
<div>
...
## Step 1: Access SaaS Development Console
...
## Step 2: Confirm MCP Server Endpoint

When the API is successfully published via Smart API Gateway feature, the following information will be displayed, so please note it down:
...
## Step 4: Prepare OpenAI Playground
...
## Step 5: Operation Verification with AI Services
...
## Step 6: API Call Test from AI Services
