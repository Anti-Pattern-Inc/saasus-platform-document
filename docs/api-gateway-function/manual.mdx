...
- **SaaS Environment and Sample App**  
  ...
  [Create a SaaS Environment and Sample App](https://github.com/saasus-platform/implementation-sample-smart-api-gateway.git)
...
3. Make the necessary configurations in the `implementation-sample-smart-api-gateway` project.
   ...
   [Reconfirming SaaS ID, API Key, and Client Secret](../tutorial/embed-the-saasus-sdk-into-your-web-application-and-make-it-multi-tenant#saas-id-と-api-キークライアントシークレットの再確認)
   :::
