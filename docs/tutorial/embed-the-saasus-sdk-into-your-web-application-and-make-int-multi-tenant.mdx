...
# SaaSus SDK を Web アプリケーションに組み込みマルチテナント化する
...
![01](/img/tutorial/embed-the-saasus-sdk-into-your-web-application-and-make-int-multi-tenant-01.png)
...
![02](/img/tutorial/embed-the-saasus-sdk-into-your-web-application-and-make-int-multi-tenant-02.png)
...
![03](/img/tutorial/embed-the-saasus-sdk-into-your-web-application-and-make-int-multi-tenant-03.png)

まだデータが無いので、いくつか投稿をしてみましょう。

![04](/img/tutorial/embed-the-saasus-sdk-into-your-web-application-and-make-int-multi-tenant-04.png)

ユーザ名も表示されていることが確認できました。

では、もう一度ログイン画面に戻り、 [user1-2@example.com](mailto:user1-2@example.com) でログインして、いくつか投稿してみましょう。

![05](/img/tutorial/embed-the-saasus-sdk-into-your-web-application-and-make-int-multi-tenant-05.png)

当然画面に反映されます。

では、もうひとつのテナントのユーザ、 [user2-1@example.com](mailto:user2-1@example.com) でログインしてみましょう

![06](/img/tutorial/embed-the-saasus-sdk-into-your-web-application-and-make-int-multi-tenant-06.png)
...
![07](/img/tutorial/embed-the-saasus-sdk-into-your-web-application-and-make-int-multi-tenant-07.png)
