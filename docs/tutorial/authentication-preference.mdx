...
The email address, password, tenant, and other user attributes added in [Declare Additional Attribute To User](../saas-development-console/declare-additional-attribute-to-user), introduced in Guides, are displayed.
...
- For Express: `api/controllers/api/board.ts`
...
Let's implement the first steps of pricing, usage measurement, and billing. 

For billing, we use a billing SaaS called Stripe. If you don't use Stripe, skip the billing part.
