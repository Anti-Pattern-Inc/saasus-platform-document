...
<!-- TODO fix link url -->
今回はテナント作成時はチュートリアルで作成した<a href="/docs/tutorial/setting-measurement-units-function-menus-and-price-plans#free-%E3%83%97%E3%83%A9%E3%83%B3" target="_blank">Freeプラン</a>を自動で適用するようになっています。
