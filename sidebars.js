      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            "part-4/mcp-server/export-metering-data",
          ...
          items: [
            {
              ...
              items: [
                "part-4/account-settings/aws-marketplace-subscription-procedure",
      ...
      items: [
        "part-6/developer-sdk-api-overview",
        {
          ...
          items: [
            {
              type: "category",
              label: "Sample Application (API Server)",
              link: {
                type: "generated-index",
                title: "Sample Application (API Server)",
                description:
                  "Implementation examples using SaaSus Platform with API server approach.",
                slug: "/part-6/implementation-guide/sample-application",
              },
              items: [
                ...
                "part-6/implementation-guide/sample-application/plan-change-implementation",
                {
                  ...
                  link: {
                    type: "doc",
                    id: "part-6/implementation-guide/sample-application/billing-dashboard",
                  },
                  items: [
                    "part-6/implementation-guide/sample-application/metering-api",
                  ],
                },
              ],
            },
