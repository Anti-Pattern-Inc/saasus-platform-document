---
title: "認証APIを利用した基本実装"
slug: "basic-sign-in"
excerpt: "SaaSus Platform 認証APIを使ったログイン処理・ログアウト処理のフロントエンド・バックエンド実装"
hidden: false
...
認証APIサンプルアプリケーションを題材に、独自ログイン画面からのログイン処理とログアウト処理の実装方法を解説します。

:::info
認証APIの概要やフローについては、[認証API実装ガイド](/docs/part-6/implementation-guide/auth/overview)をご参照ください。
:::
