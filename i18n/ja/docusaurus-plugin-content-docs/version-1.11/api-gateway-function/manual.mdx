...
1. **[API Gateway 機能 β 版利用申請フォーム](https://docs.google.com/forms/d/e/1FAIpQLSftCXrCOH-19uoVyaziajuRSdvwCzdlteqK5xLxjvYs3Lz7Ww/viewform)** アクセスし、必要事項を記入の上、利用申請を行ってください。

:::info
利用申請後、弊社より確認メールを送付いたします。<br/>
メールが届くまでの間に、Step 2 以降の手順を進めてお待ちください。
:::
...
1. 弊社から送信された確認メールを受信後、開発コンソールの API Gateway 機能画面にアクセスしてください。
