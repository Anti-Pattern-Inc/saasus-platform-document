...
Blade 版では、api/app/Http/Controllers/MessageController.php のpostメソッドを書き換えてみましょう。

Next.js 版では、api/controllers/api/board.ts へimport文を追加し、postメソッドを書き換えてみましょう。
