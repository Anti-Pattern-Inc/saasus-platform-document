...
冒頭で行ったとおり、 init.sh を利用して docker コンテナが立ち上がっており、[http://localhost/board](http://localhost/board) でサンプルアプリケーションが動いていることを確認してください。
...
![16](/ja/img/tutorial/authentication-preference/authentication-preference-16.png)
