...
テナント管理者が日付やメータリングユニットを上記の使用量を確認できる機能を作成します。

<details><summary><b>今回の実装例で利用する料金プラン作成</b></summary>
...
<!-- TODO fix link url -->
<a href="doc:tiered_unit">段階ユニット、段階的使用量ユニットの料金計算の違いについて</a>
...
<details><summary><b>React実装サンプル</b></summary>
...
<details><summary><b>Laravel実装サンプル</b></summary>
