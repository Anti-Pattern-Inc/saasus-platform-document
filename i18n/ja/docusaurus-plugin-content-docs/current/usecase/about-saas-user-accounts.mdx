...
<a href="/ja/docs/usecase/about-saas-user-accounts/create-tenant" target="blank">テナントの作成</a>を参考に、テナント情報が登録できるよう修正してみましょう。

テナント情報が登録できるようになったら、<a href="/ja/docs/usecase/about-saas-user-accounts/add-tenant-user" target="_blank">テナントにユーザーを紐づけロールを設定</a>してみましょう。
...
SaaSにユーザー登録ができたら、登録者のUserInfo配列内の tenants からテナント情報を取得し、<a href="/ja/docs/usecase/about-saas-user-accounts/add-tenant-user" target="_blank">テナントにユーザーを紐づけロールを設定</a>してみましょう。
