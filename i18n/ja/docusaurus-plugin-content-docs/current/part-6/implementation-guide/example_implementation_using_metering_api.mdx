...
3. ユーザー数とアクティブユーザー数のメーター単位を作成します
    ...
    ![](/ja/img/part-6/implementation-guide/example_implementation_using_metering_api/image-09.png)

    ![](/ja/img/part-6/implementation-guide/example_implementation_using_metering_api/image-10.png)
...
2. 計測単位設定画面右上にある「固定ユニット計測単位の作成」の右側にある「▼」をクリックし、「使用量ユニット計測単位の作成」を選択後、「使用量ユニット計測単位の作成」ボタンをクリックしてください
   ...
   ![](/ja/img/part-6/implementation-guide/example_implementation_using_metering_api/image-03.png)
3. ユーザー数とアクティブユーザー数の計測単位を設定します

   ![](/ja/img/part-6/implementation-guide/example_implementation_using_metering_api/image-04.png)

   ![](/ja/img/part-6/implementation-guide/example_implementation_using_metering_api/image-05.png)
...
3. 計測単位にユーザー数とアクティブユーザー数を設定した機能メニューを作成します
   ...
   ![](/ja/img/part-6/implementation-guide/example_implementation_using_metering_api/image-06.png)
...
3. 機能メニューに作成した機能メニューを設定した料金プランを作成します
   ...
   ![](/ja/img/part-6/implementation-guide/example_implementation_using_metering_api/image-07.png)
...
3. 作成した料金プランを設定、反映日をすぐ反映にして保存します
   ...
   ![](/ja/img/part-6/implementation-guide/example_implementation_using_metering_api/image-08.png)
...
![](/ja/img/part-6/implementation-guide/example_implementation_using_metering_api/metering_system_example.gif)
