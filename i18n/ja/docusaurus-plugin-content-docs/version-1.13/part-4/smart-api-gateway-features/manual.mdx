...
- SaaS 環境とサンプルアプリ<br/>
  AWS CloudFormation で AWS に SaaS 環境とサンプルアプリを作成します。<br/>
...
1. SaaS 開発コンソールの Smart API Gateway 機能画面にアクセスしてください。
...
- API のアクセスには **API Key** が必要です。SaaS 運用コンソールの **テナント管理画面**で API Key を発行し、アクセスに利用します。
...
- 検証のため、SaaS 開発コンソールの **役割定義**で一般ユーザーというロールを作成してください。
- ロールによる認可にはユーザーの **API Key** が必要です。SaaS 運用コンソールの **ユーザー管理画面**でユーザーを作成し、API Key を発行してください。
- SaaS 運用コンソールの**役割管理**から作成したユーザーに一般ユーザーのロールを設定してください。
...
- SaaS 運用コンソールの **テナント管理画面**で IP 制限を設定してください。
