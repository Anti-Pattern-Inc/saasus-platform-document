...
To reset the password for such a user, an administrator should perform the password reset from the User Management screen in the SaaS Operation Console. For details, see [Search, Edit, Create, or Assign Users to Tenants](/docs/part-5/user-management/user-crud).
